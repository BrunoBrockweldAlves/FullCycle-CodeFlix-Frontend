...
import { ChevronDownIcon, PlusIcon, SpeakerWaveIcon, UserGroupIcon } from "@heroicons/react/24/outline";
  ...
  <div className="group relative min-h-[12vh] rounded bg-zinc-900 md:min-h-[12vw]">
    ...
    />
      ...
      >
        ...
        <div className='absolute z-10 w-full rounded-b-md bg-zinc-800 b-2 shadow-md transition lg:p-4'>
...
export function MoviewRow({sectionTitle, movies}:MovieRowProps) {
  return (
